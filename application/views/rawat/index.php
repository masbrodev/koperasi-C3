...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">DATA PASIEN JALAN</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">PASIEN JALAN</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  foreach ($data as $a) {?>
                    ...
                    <td>
                      <a href="<?php echo site_url('jalan/edit/'.$a['id_pasien']);?>"><i title="edit" class="fa fa-edit"></i></a>
                      <a data-href="<?php echo site_url('jalan/actiondelete/'.$a['id_pasien']);?>" data-toggle="modal" data-target="#confirm-delete<?php echo $i;?>" href="#"><i title="delete" class="fa fa-trash"></i></a>
                          ...
                          <div class="modal-dialog">
                              <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                      ...
                                      <a href="<?php echo site_url('jalan/actiondelete/'.$a['id_pasien']);?>" class="btn btn-danger danger">Delete</a>
                                  </div>
                              </div>
                          </div>
                      </div>
