                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form role="form" enctype="multipart/form-data" method="post" action="<?php echo site_url('inap/actionedit');?>">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Tanggal Keluar Pasien</label>
                                            <input type="date" name="tgl_keluar" class="form-control" id="exampleInputUsername1">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Ruang Tujuan</label>
                                            <select class="form-control" name="tujuan">
                                              <?php foreach ($room as $a) {?>
                                                    <option value="<?php echo $a['nomor_room']; ?>"<?php if($data['tujuan']==$a['nomor_room']) echo 'selected="selected"'; ?>><?php echo $a['nomor_room']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div><!-- /.box-body -->
                                    ...
                                    <div class="box-footer">
                                      <input type="hidden" name="roomasli" value="<?php echo $data['tujuan'];?>">
